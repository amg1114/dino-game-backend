...
export class VideoGamesSeed1746155837792 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
        ...
        (39, 'final-fantasy-vii-thumb.jpg', 'https://firebasestorage.googleapis.com/v0/b/dinogame-6bcaa.appspot.com/o/uploads%2Fvideo-games%2F20%2Ffinal-fantasy-vii-thumb.jpg?alt=media&token=1b5f403d-2594-4e88-b3e4-77adbe2dceb6'),
